    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_date', models.DateTimeField(auto_now_add=True, verbose_name=b'GoodUserRaw creation date')),
                ('last_update_date', models.DateTimeField(auto_now=True, verbose_name=b'GoodUserRaw creation date')),
            ],
            options={
